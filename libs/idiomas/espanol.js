...
//autobio
const Bio = { 
text: `🦁 𝙲𝙾𝚁𝚃𝙰𝙽𝙰𝙱𝙾𝚃-𝟸.𝟶 - ᴛᴇɴɢᴏ:`, 
text2: `ᴜsᴜᴀʀɪᴏs ᴜsᴀᴅᴏʀᴍᴇ ᴘᴜᴇᴅᴏ ʀᴇsᴘᴏɴᴅᴇ ʟᴇɴᴛᴀ ᴍɪ ᴠᴇʟᴏᴄɪᴅᴀᴅ ᴅᴇ ʀᴇsᴘᴜᴇsᴛᴀ ᴇs:`,
text3: `👑 𝙲𝙾𝚁𝚃𝙰𝙽𝙰𝙱𝙾𝚃-𝟸.𝟶 | 𝙰𝙲𝚃𝙸𝚅𝙾 ✅️:`, 
text4: `ᴘᴀʀᴀ ᴠᴇᴢ ᴍɪ ʟɪsᴛᴀ ᴅᴇ ᴄᴏᴍᴀɴᴅᴏ ᴜsᴀʀ #menu`, 
text5: `𝚂𝙴𝙶𝚄𝙸𝚁𝙼𝙴 𝙴𝙻 𝚃𝙸𝙺𝚃𝙾𝙺 : https://www.tiktok.com/@russellpaypal?_t=8kkT6zjzePf&_r=1`, 
text6: `✅ Actividad:`, 
text7: `👥 Usuarios:` }
...
*𝘚𝘦𝘳𝘷𝘪𝘤𝘪𝘰 𝘱𝘳𝘰𝘷𝘦𝘪𝘥𝘰 𝘱𝘰𝘳 𝘊𝘰𝘳𝘵𝘢𝘯𝘢𝘉𝘰𝘵*`, 
...
rob2: `*😔 ᴇʟ ᴜsᴜᴀʀɪᴏ*`, 
rob3: `*ᴛɪᴇɴᴇ ᴍᴇɴᴏs ᴅᴇ 15 ᴄʀᴇ́ᴅɪᴛᴏ, ɴᴏ ʀᴏʙᴇs ᴀ ᴜɴ ᴘᴏʙʀᴇ*`, 
...
buy5: `ᴄʀᴇᴅɪᴛᴏ ᴘᴜᴇᴅᴇs ᴄᴏɴsᴇɢᴜɪʀ *xᴘ* ᴜsᴀɴᴅᴏ ᴇʟ ᴄᴏᴍᴀɴᴅᴏs #minar`, 
pp: `              *⪨ ＰＥＲＦＩＬ ⪩*`, 
pp2: `*💫 NOMBRE :*`, 
pp3: `*📱 NUMERO :*`, 
pp4: `*💳 CRÉDITO :*`, 
...
const smsReg7 = (name, user, age, time, date, sender, sn, prefix, rtotalreg) => { return `┌────「 *ⱤɆ₲ł₴₮Ɽ₳ĐØ* 」─
(⛦) *ᴜsᴇʀ*: @${sender.split("@")[0]}
(⛦) *ɴᴏᴍʙʀᴇ:* _${name}_
